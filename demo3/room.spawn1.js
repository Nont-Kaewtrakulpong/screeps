...
var roomSpawn1 = {
    ...
    else if(distanceHarvesters.length < 0) {
    ...
    else if(distanceBuilders.length < 0) {
    ...
    var sourceMain = ['5bbcaedb9099fc012e639a8f', '5bbcaedb9099fc012e639a91'];
